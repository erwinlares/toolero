...
Description: Provides utility functions to help researchers implement best
    ...
    structure and optional YAML configuration, recording the resolved
    structure in a project manifest that downstream tools can read,
    ...
    into group-level output files, applying analysis functions to each group
    with optional parallel execution, and rendering syntactic tree diagrams
    as standalone PNG images via 'Typst'.
