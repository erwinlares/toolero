...
to UW-Madison’s. These Quarto-based reporting templates are baked into
the package as defaults. If you are not at UW-Madison, the branding
files are optional – and you can replace with your own. the rest of the
...
the UW-Madison branding files into `assets/`. The
[`create_qmd()`](https://erwinlares.github.io/toolero/reference/create_qmd.md)
