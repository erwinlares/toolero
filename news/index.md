...
- Resubmission addressing CRAN feedback: removed redundant “in R” from
  title, replaced `\dontrun{}` with `\donttest{}` throughout, removed
  default write paths in
  [`create_qmd()`](https://erwinlares.github.io/toolero/reference/create_qmd.md)
  and
  [`write_by_group()`](https://erwinlares.github.io/toolero/reference/write_by_group.md),
  and replaced non-ASCII characters in source files.
