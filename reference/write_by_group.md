...
#> ✔ Written "Adelie" (2 rows) to /tmp/Rtmpzi3IQZ/adelie.csv
#> ✔ Written "Gentoo" (1 rows) to /tmp/Rtmpzi3IQZ/gentoo.csv
...
write_by_group(data2, group_col = c("species", "sex"),
               output_dir = tempdir(), manifest = TRUE)
#> ✔ Written "Adelie | female" (1 rows) to /tmp/Rtmpzi3IQZ/adelie--female.csv
#> ✔ Written "Adelie | male" (1 rows) to /tmp/Rtmpzi3IQZ/adelie--male.csv
#> ✔ Written "Gentoo | male" (1 rows) to /tmp/Rtmpzi3IQZ/gentoo--male.csv
#> ✔ Manifest written to /tmp/Rtmpzi3IQZ/manifest.csv
# }
```
