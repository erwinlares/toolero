...
#> ✔ Created /tmp/RtmpP0wBoz/analysis.qmd

# Full worked example with sample data and placeholder logo
create_qmd(path = tempdir(), filename = "analysis.qmd",
           overwrite = TRUE)
#> ✔ Created /tmp/RtmpP0wBoz/data-raw/sample.csv
#> ✔ Created /tmp/RtmpP0wBoz/assets/logo.png
#> ✔ Created /tmp/RtmpP0wBoz/analysis.qmd
...
#> ✔ Created /tmp/RtmpP0wBoz/data-raw/sample.csv
#> ℹ Skipping /tmp/RtmpP0wBoz/assets/logo.png -- existing logo left in place.
#> ✔ Created /tmp/RtmpP0wBoz/analysis.qmd
#> ✔ Created /tmp/RtmpP0wBoz/R/purl.R
#> ✔ Created /tmp/RtmpP0wBoz/_quarto.yml
...
create_qmd(path = tempdir(), filename = "report.qmd",
           ...
           overwrite = TRUE)
#> Warning: No styles.css, header.html, or footer.html found in /tmp/RtmpP0wBoz/assets.
#> Skipping style injection.
#> ✔ Created /tmp/RtmpP0wBoz/report.qmd
