...
#> ✔ Created /tmp/RtmpMeZi4l/analysis.qmd

# Full worked example with sample data and placeholder logo
create_qmd(path = tempdir(), filename = "analysis.qmd",
           overwrite = TRUE)
#> ✔ Created /tmp/RtmpMeZi4l/data-raw/sample.csv
#> ✔ Created /tmp/RtmpMeZi4l/assets/logo.png
#> ✔ Created /tmp/RtmpMeZi4l/analysis.qmd
...
#> ✔ Created /tmp/RtmpMeZi4l/data-raw/sample.csv
#> ℹ Skipping /tmp/RtmpMeZi4l/assets/logo.png -- existing logo left in place.
#> ✔ Created /tmp/RtmpMeZi4l/analysis.qmd
#> ✔ Created /tmp/RtmpMeZi4l/R/purl.R
#> ✔ Created /tmp/RtmpMeZi4l/_quarto.yml
...
create_qmd(path = tempdir(), filename = "report.qmd",
           ...
           overwrite = TRUE)
#> Warning: No styles.css, header.html, or footer.html found in /tmp/RtmpMeZi4l/assets.
#> Skipping style injection.
#> ✔ Created /tmp/RtmpMeZi4l/report.qmd
