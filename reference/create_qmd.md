...
#> ✔ Created /tmp/RtmpmVDia1/analysis.qmd

# Full worked example with sample data and placeholder logo
create_qmd(path = tempdir(), filename = "analysis.qmd",
           overwrite = TRUE)
#> ✔ Created /tmp/RtmpmVDia1/data-raw/sample.csv
#> ✔ Created /tmp/RtmpmVDia1/assets/logo.png
#> ✔ Created /tmp/RtmpmVDia1/analysis.qmd
...
#> ✔ Created /tmp/RtmpmVDia1/data-raw/sample.csv
#> ℹ Skipping /tmp/RtmpmVDia1/assets/logo.png -- existing logo left in place.
#> ✔ Created /tmp/RtmpmVDia1/analysis.qmd
#> ✔ Created /tmp/RtmpmVDia1/R/purl.R
#> ✔ Created /tmp/RtmpmVDia1/_quarto.yml
...
create_qmd(path = tempdir(), filename = "report.qmd",
           ...
           overwrite = TRUE)
#> Warning: No styles.css, header.html, or footer.html found in /tmp/RtmpmVDia1/assets.
#> Skipping style injection.
#> ✔ Created /tmp/RtmpmVDia1/report.qmd
