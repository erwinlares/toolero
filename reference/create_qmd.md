...
#> ✔ Created /tmp/Rtmpkvf8B7/analysis.qmd

# Full worked example with sample data and placeholder logo
create_qmd(path = tempdir(), filename = "analysis.qmd",
           overwrite = TRUE)
#> ✔ Created /tmp/Rtmpkvf8B7/data-raw/sample.csv
#> ✔ Created /tmp/Rtmpkvf8B7/assets/logo.png
#> ✔ Created /tmp/Rtmpkvf8B7/analysis.qmd
...
#> ✔ Created /tmp/Rtmpkvf8B7/data-raw/sample.csv
#> ℹ Skipping /tmp/Rtmpkvf8B7/assets/logo.png -- existing logo left in place.
#> ✔ Created /tmp/Rtmpkvf8B7/analysis.qmd
#> ✔ Created /tmp/Rtmpkvf8B7/R/purl.R
#> ✔ Created /tmp/Rtmpkvf8B7/_quarto.yml
...
create_qmd(path = tempdir(), filename = "report.qmd",
           ...
           overwrite = TRUE)
#> Warning: No styles.css, header.html, or footer.html found in /tmp/Rtmpkvf8B7/assets.
#> Skipping style injection.
#> ✔ Created /tmp/Rtmpkvf8B7/report.qmd
