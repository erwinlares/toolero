...
#> Error in check_project(path = project_dir): Directory /tmp/Rtmp1VmBx5/file4e59445c29c1 does not exist.
# }
...
#> ✔ Created /tmp/Rtmp1VmBx5/my-config.yml
#> ℹ Edit /tmp/Rtmp1VmBx5/my-config.yml to define your custom folder structure,
#>   then pass it to `init_project()` via `config =
#>   "/tmp/Rtmp1VmBx5/my-config.yml"`.
...
#> Error in check_project(path = project_dir, config = config_path): Directory /tmp/Rtmp1VmBx5/file4e597de8b52c does not exist.
# }
...
#> Error in check_project(path = project_dir): Directory /tmp/Rtmp1VmBx5/file4e591489f3a3 does not exist.
# }
```
